...
cargo run -p sg-cli -- --root examples/backend-api-typescript module import --file modules.yaml
cargo run -p sg-cli -- --root examples/backend-api-typescript module validate --gate spec-authoring

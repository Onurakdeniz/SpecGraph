...
pub const BUILT_IN_STABLE_KEY_FAMILIES: &[StableKeyFamily] = &[
    ...
    StableKeyFamily {
        prefix: "validation-recipe",
        description: "Required validation recipe for an action or release gate",
        example: "validation-recipe:AUTH-001/implementation/build",
    },
    StableKeyFamily {
        prefix: "validation-command",
        description: "Declared validation command requirement without automatic execution",
        example: "validation-command:AUTH-001/implementation/build/cargo-build",
    },
    StableKeyFamily {
        prefix: "build-run",
        description: "Recorded build evidence for a validation run",
        example: "build-run:validation-123/cargo-build",
    },
    StableKeyFamily {
        prefix: "typecheck-run",
        description: "Recorded typecheck evidence for a validation run",
        example: "typecheck-run:validation-123/cargo-check",
    },
    StableKeyFamily {
        prefix: "lint-run",
        description: "Recorded lint evidence for a validation run",
        example: "lint-run:validation-123/cargo-clippy",
    },
    StableKeyFamily {
        prefix: "format-check",
        description: "Recorded format-check evidence for a validation run",
        example: "format-check:validation-123/cargo-fmt",
    },
    StableKeyFamily {
        prefix: "test-intent",
        description: "Required test scenario intent linked to an acceptance criterion",
        example: "test-intent:AUTH-001/ac-existing-email",
    },
    StableKeyFamily {
        prefix: "test-assertion",
        description: "Assertion required by a test intent",
        example: "test-assertion:AUTH-001/ac-existing-email/sends-token",
    },
    StableKeyFamily {
        prefix: "positive-case",
        description: "Positive test scenario case evidence",
        example: "positive-case:AUTH-001/ac-existing-email",
    },
    StableKeyFamily {
        prefix: "negative-case",
        description: "Negative test scenario case evidence",
        example: "negative-case:AUTH-001/ac-unknown-email",
    },
    StableKeyFamily {
        prefix: "regression-case",
        description: "Regression test scenario case evidence",
        example: "regression-case:AUTH-001/token-reuse",
    },
    StableKeyFamily {
        prefix: "security-case",
        description: "Security test scenario case evidence",
        example: "security-case:AUTH-001/rate-limit",
    },
    StableKeyFamily {
        prefix: "review",
        description: "Code, PR, or manual review fact",
        example: "review:AUTH-001/pr-42",
    },
    StableKeyFamily {
        prefix: "review-comment",
        description: "Review comment fact from manual or provider input",
        example: "review-comment:AUTH-001/pr-42/comment-1",
    },
    StableKeyFamily {
        prefix: "requested-change",
        description: "Review-requested change that must be resolved before completion",
        example: "requested-change:AUTH-001/pr-42/change-1",
    },
    StableKeyFamily {
        prefix: "review-resolution",
        description: "Resolution evidence for a requested review change",
        example: "review-resolution:AUTH-001/pr-42/change-1",
    },
    StableKeyFamily {
        prefix: "review-approval",
        description: "Scoped approval evidence for a review or requested change",
        example: "review-approval:AUTH-001/pr-42/lead",
    },
    StableKeyFamily {
        prefix: "rollout-plan",
        description: "Risky release rollout plan evidence",
        example: "rollout-plan:release-1/phased",
    },
    StableKeyFamily {
        prefix: "feature-flag",
        description: "Feature flag used for rollout or rollback control",
        example: "feature-flag:password-reset-v2",
    },
    StableKeyFamily {
        prefix: "rollback-strategy",
        description: "Rollback strategy evidence for a release",
        example: "rollback-strategy:release-1/revert",
    },
    StableKeyFamily {
        prefix: "post-release-check",
        description: "Post-release validation check fact",
        example: "post-release-check:release-1/smoke",
    },
    StableKeyFamily {
        prefix: "release-health-check",
        description: "Release health check fact",
        example: "release-health-check:release-1/error-rate",
    },
    StableKeyFamily {
        prefix: "metric",
        description: "Required or observed operational metric fact",
        example: "metric:auth/password-reset-requests",
    },
    StableKeyFamily {
        prefix: "log-event",
        description: "Required or observed log event fact",
        example: "log-event:auth/password-reset-requested",
    },
    StableKeyFamily {
        prefix: "trace-span",
        description: "Required or observed trace span fact",
        example: "trace-span:auth/request-password-reset",
    },
    StableKeyFamily {
        prefix: "audit-event",
        description: "Required or observed audit event fact",
        example: "audit-event:auth/password-reset-requested",
    },
    StableKeyFamily {
        prefix: "operational-alert",
        description: "Operational alert fact",
        example: "operational-alert:auth/password-reset-error-rate",
    },
    StableKeyFamily {
        prefix: "slo",
        description: "Service-level objective fact",
        example: "slo:auth/password-reset-availability",
    },
    StableKeyFamily {
...
mod tests {
    ...
    fn accepts_existing_stable_key_formats() {
        for value in [
            ...
            "validation-recipe:AUTH-001/implementation/build",
            "validation-command:AUTH-001/implementation/build/cargo-build",
            "build-run:validation-123/cargo-build",
            "typecheck-run:validation-123/cargo-check",
            "lint-run:validation-123/cargo-clippy",
            "format-check:validation-123/cargo-fmt",
            "test-intent:AUTH-001/ac-existing-email",
            "test-assertion:AUTH-001/ac-existing-email/sends-token",
            "positive-case:AUTH-001/ac-existing-email",
            "negative-case:AUTH-001/ac-unknown-email",
            "regression-case:AUTH-001/token-reuse",
            "security-case:AUTH-001/rate-limit",
            "review:AUTH-001/pr-42",
            "review-comment:AUTH-001/pr-42/comment-1",
            "requested-change:AUTH-001/pr-42/change-1",
            "review-resolution:AUTH-001/pr-42/change-1",
            "review-approval:AUTH-001/pr-42/lead",
            "rollout-plan:release-1/phased",
            "feature-flag:password-reset-v2",
            "rollback-strategy:release-1/revert",
            "post-release-check:release-1/smoke",
            "release-health-check:release-1/error-rate",
            "metric:auth/password-reset-requests",
            "log-event:auth/password-reset-requested",
            "trace-span:auth/request-password-reset",
            "audit-event:auth/password-reset-requested",
            "operational-alert:auth/password-reset-error-rate",
            "slo:auth/password-reset-availability",

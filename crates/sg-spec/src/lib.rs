//! Boundary crate for `sg-spec` in the SpecGraph OS modular workspace.
//!
...
pub use sg_core::{
    spec_status, transition_spec_state, SpecProjection, SpecStatusSummary, TextItem,
    TransitionSpecOptions,
};

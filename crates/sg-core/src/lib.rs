...
pub use adapter::{
    ...
    validate_adapter_delta, validate_adapter_output, AdapterCapability, AdapterCapabilityBroker,
    AdapterConfigEntry, AdapterConfigFile, AdapterDescriptor, AdapterOutputEnvelope,
    AdapterProvenanceEnvelope, AdapterRegistry, AdapterRegistryEntry, AdapterSignature,
    AdapterTrustLevel, ADAPTER_CONFIG_RELATIVE_PATH, ADOPTION_ADAPTER_ID, CI_ADAPTER_ID,

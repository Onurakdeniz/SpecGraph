...
pub use store::{
    ...
    upsert_modules, upsert_project_profile, validate_snapshots, validation_recipe_gate_findings,
    ActionGraphSummary, ActionGroupSummary, ActionLifecycleOptions, AppendOperationOptions,
    BindBranchOptions, CreateWaiverOptions, ExistingFeatureMatch, GenerateActionGraphOptions,
    GrantRoleOptions, InitOptions, IntentAnswer, IntentAssumption, IntentClarification,
